        ...
        <div>
          <div className="bg-gray-300 text-sm">
            <div className="flex justify-between ">
              <div>
                {consultationStatus.isNewApply && <div className="h-1 w-1 rounded-xl bg-status-alert"></div>}
                <span>신규예약</span>
              </div>
            ...
            <div className="flex w-full justify-between ">
              <div>
                {consultationStatus.isNewConfirm && <div className="h-1 w-1 rounded-xl bg-status-alert"></div>}
                <span>예약확정</span>
              </div>
            ...
            <div className="flex w-full justify-between ">
              <div>
                {consultationStatus.isNewComplete && <div className="h-1 w-1 rounded-xl bg-status-alert"></div>}
                <span>상담완료</span>
              </div>
