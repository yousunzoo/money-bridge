  ...
  return (
    <html lang="ko">
      <head>
        ...
        <meta property="og:title" content="위치기반 투자자 PB 매칭 플랫폼" />
        <meta property="og:url" content="https://www.moneybridge.co.kr/" />
        <meta property="og:image" content="/assets/images/money-bridge-banner.png" />
        ...
        <meta name="twitter:image" content="/assets/images/money-bridge-banner.png" />
