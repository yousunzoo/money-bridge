...
function CalendarModal({
  ...
  return (
    <section className="fixed left-0 top-0 z-30 h-full w-full">
      ...
      <div className=" fixed bottom-0 left-1/2 z-10 flex min-w-[380px]  max-w-[320px] -translate-x-1/2 flex-col items-center rounded-t-md bg-white px-6 py-6 shadow-lg">
