...
function CalendarModal({
  ...
  return (
    <section className=" fixed bottom-[70px] left-1/2 z-10 flex min-w-[380px]  max-w-[320px] -translate-x-1/2 flex-col items-center rounded-t-md bg-white px-6 py-6 shadow-lg">
