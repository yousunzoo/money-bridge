...
const FOOTER_NOTICE_INFO = [
  ...
  { id: 3, title: "주소", text: "서울시 영등포구 당산로 41길 11, E동 1202호" },
];
...
const FOOTER_COMPANY_INFO = [
  ...
  { id: 4, title: "개인정보 처리지침", href: "/privacy" },
];
...
function Footer() {
  ...
  return (
    !inValueIncluded && (
      <footer className="relative bottom-0 mx-[-16px]  mt-4 flex h-[410px]  flex-col border-t-1 border-button-inactive bg-background-primary p-8 md:h-[280px] ">
        <div className="flex flex-col justify-between gap-10 md:flex-row">
          <section className="md:mix-w-[320px] flex w-auto flex-col md:max-w-[350px] ">
            <h3 className="text-md font-bold">Notice</h3>
            <p className="mt-2 w-auto break-words text-xs">
              머니브릿지 서비스의 모든 내용은 정보를 제공하기 위함이며, 본 플랫폼에서 직접적인 투자권유를 하고 있지
              않습니다. 증권사 PB의 정보를 중개하는 목적으로 운영되고 있으며 머니브릿지는 매칭 이후 발생하는 내용에
              대해서 알지 못하며 어떠한 책임도 없고 모든 책임과 발생한 결과는 투자자 본인의 책임입니다.
            </p>
            <ul className="mt-4 gap-1 text-xs">
          ...
          <section className="mix-w-[300px] flex justify-between md:w-1/2">
            <article>
              <h3 className="text-md font-bold">고객센터</h3>
            ...
            <article>
              <h3 className="text-md font-bold">회사소개</h3>
              <ul className="mt-2 flex flex-col gap-1 text-xs font-bold">
        ...
        <p className="mt-4 self-center text-xs ">Copyright ⓒ {currentYear} 시스메틱 All rights reserved </p>
      </footer>
    )
  );
}
